...
var TableEditable_CategoryOverview = function () {
	return {
					...
					success: function(msg)
					{
						if(msg.success==1)
						{
							if(msg.from=='add')
							{
								...
								newaccordion='<div class="accordion-group sidebar_course" course_id="'+msg.course.course_id+'" category_id="'+msg.course.category_id+'"><div class="accordion-heading">';
...
//								$('#side_accordion').html($('#side_accordion').html()+newaccordion);
								$('.accordion-group .categoryoverview[category_id='+msg.course.category_id+']').closest('.accordion-group').after(newaccordion);
...
//								 Editing this row and want to save it 
					if($(nRow).attr('course_id'))
						...
						ajax_helper({'operation':'add_course','course_name':$("#course_name").val(),'price':$("#course_price").val(),'description':$("#course_description").val(),
						'duration':$("#course_duration").val(),'category_id':$(this).closest('table').attr('category_id')},nEditing);
